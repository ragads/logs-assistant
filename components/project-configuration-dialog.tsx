...
export function ProjectConfigurationDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-ink/45 p-4" onClick={onClose}>
      ...
      <section
        className="flex max-h-[calc(100vh-2rem)] w-full max-w-lg flex-col overflow-hidden rounded-lg border border-line bg-white shadow-panel"
      ...
      >
        ...
        <form onSubmit={submit} className="flex min-h-0 flex-1 flex-col">
          ...
          <div className="modal-scroll grid gap-4 overflow-y-auto p-5">
