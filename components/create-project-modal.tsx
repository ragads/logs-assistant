  ...
  return (
    <>
      ...
      {open && (
        ...
        >
          <div
            className="w-full max-w-lg overflow-hidden rounded-xl border border-line bg-white shadow-panel"
            onClick={(event) => event.stopPropagation()}
          >
            {/* Header */}
            <div className="flex items-start justify-between gap-4 border-b border-line bg-cloud px-6 py-5">
